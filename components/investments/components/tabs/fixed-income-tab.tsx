...
export function FixedIncomeTab() {
  ...
  // ---- editable/read-only (igual orçamento) ----
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-6 pb-10 sm:pb-0">
        ...
        {fixedIncome.length > 0 ? (
          <div className="sticky bottom-0  border-t bg-background/80 px-4 pt-3 backdrop-blur sm:static sm:-mx-0 sm:border-0 sm:bg-transparent sm:px-0 sm:pb-0">
